...
export const UI = {
  kk: {
    ...
    brand: 'АДАМ БАСЫ',
    brandMark: 'БАСЫ',
    sub: 'Ересек қазақ · бас пен мойын',
    subM: 'Ересек қазақ ер адамы',
    subF: 'Ересек қазақ әйелі',
    loading: 'Жүктелуде',
    ...
    about: {
      ...
      title: 'Атлас туралы',
      body: [
        'Бұл — ересек қазақ ер адамы мен әйелінің басы мен мойнының интерактивті 3D атласы. Ол білім алуға арналған; медициналық немесе диагностикалық құрал емес.',
      ...
      simpl: [
        'Беттер — осы атлас үшін жасалған идеалдандырылған адамдар.',
      ...
      lic: [
        ...
        'three.js — MIT',
        'Inter, Space Grotesk, IBM Plex Mono — SIL OFL 1.1',
  ...
  ru: {
    ...
    brandMark: 'ГОЛОВА',
    sub: 'Взрослые казах и казашка · голова и шея',
    subM: 'Взрослый казах',
    subF: 'Взрослая казашка',
    loading: 'Загрузка',
    ...
    about: {
      ...
      title: 'Об атласе',
      body: [
        'Интерактивный 3D-атлас головы и шеи взрослых казаха и казашки. Он создан для обучения и не является медицинским или диагностическим инструментом.',
      ...
      simpl: [
        'Лица — идеализированные люди, созданные для этого атласа.',
  ...
  en: {
    ...
    brand: 'THE HEAD',
    brandMark: 'HEAD',
    sub: 'Adult Kazakh man and woman · head and neck',
    subM: 'Adult Kazakh man',
    subF: 'Adult Kazakh woman',
    loading: 'Loading',
    ...
    about: {
      ...
      body: [
        'An interactive 3D atlas of the head and neck of an adult Kazakh man and woman. It is made for learning, not as a medical or diagnostic tool.',
      ...
      simpl: [
        'The faces are idealised people created for this atlas.',
