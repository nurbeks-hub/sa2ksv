...
export const UI = {
  kk: {
    ...
    toggleSystemHint: 'Жүйені жасыру не қайтару үшін ұзақ басыңыз немесе оң жақ батырманы шертіңіз',
    systems: {
      skin: 'Тері', muscles: 'Бұлшықеттер', tendon: 'Сіңірлер',
      vessels: 'Қан тамырлары', artery: 'Күретамырлар', vein: 'Көктамырлар',
    ...
    tourStops: [
      ...
      { t: 'Қан тамырлары', s: 'Күретамыр қанды жүректен әкеледі, көктамыр кері қайтарады' },
      ...
      { t: 'Ми', s: 'Дене салмағының шамамен 2%-ы, ал тыныштықтағы энергияның 20%-ы' },
    ...
    about: {
      ...
      simpl: [
        ...
        'BodyParts3D бір жапон ер адамының денесі негізінде жасалған; орташа пішінге қазақтарды сканерлеу арқылы емес, деформация арқылы жетті.',
        ...
        'Қима беттерінің түстері схемалық.',
      ],
